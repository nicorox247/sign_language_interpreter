...
Original file is located at
    https://colab.research.google.com/drive/1E6rRGs8ikg0pTrEA9Uwu-GkgtPXYrCFV
...
class SignLanguage:
    ...
    def create_model(self):
        ...
        # Dense layer to learn combinations of features
    ...
    def prepare_data(self, images, labels):
        ...
        # Reshape Image and Split Data
        images = images.reshape((images.shape[0], 28, 28, 1))

        # Normalize (divide by greyscale channel pixel values to get 0, 1)
        images = images.astype('float32') / 255.0

        # SKlearn data division
    ...
    def predict(self, data):
        ...
        # Convert to class labels by choosing the class with the highest probability
